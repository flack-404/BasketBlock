...
const QRCodeInvitation = () => {
  return (
    <div className='absolute left-2/4 top-0 h-full max-h-screen w-screen -translate-x-2/4 overflow-hidden mobile-demo:w-[500px]'>
      <NextImage
        src='/images/ufc.png'
        fill
      ...
      <div className='absolute top-0 flex h-full w-full max-w-[90vw] flex-col items-center justify-center inset-x-center mobile-demo:max-w-[450px]'>
        <div className='flex h-full w-full flex-col items-center justify-center'>
          <NextImage
            ...
            alt='qr-code'
          />
          <h1 className='text-gradient-primary track-wide mt-10'>
            BasketBlock
          </h1>
